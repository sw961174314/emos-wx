<template>
	<view class="page">
		<swiper circular="true" duration="1000" interval="8000" class="swiper">
			<swiper-item>
				<image mode="widthFix" src="https://sw961174314-1305711112.cos.ap-guangzhou.myqcloud.com/img/banner/swiper-1.jpg"></image>
			</swiper-item>
			<swiper-item>
				<image mode="widthFix" src="https://sw961174314-1305711112.cos.ap-guangzhou.myqcloud.com/img/banner/swiper-2.jpg"></image>
			</swiper-item>
			<swiper-item>
				<image mode="widthFix" src="https://sw961174314-1305711112.cos.ap-guangzhou.myqcloud.com/img/banner/swiper-3.jpg"></image>
			</swiper-item>
			<swiper-item>
				<image mode="widthFix" src="https://sw961174314-1305711112.cos.ap-guangzhou.myqcloud.com/img/banner/swiper-4.jpg"></image>
			</swiper-item>
			<swiper-item>
				<image mode="widthFix" src="https://sw961174314-1305711112.cos.ap-guangzhou.myqcloud.com/img/banner/swiper-5.jpg"></image>
			</swiper-item>
		</swiper>
